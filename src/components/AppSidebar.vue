...
<template>
  <aside class="app-sidebar">
    ...
    <div class="glass-card text-center p-5">
      <div
        class="w-17 h-17 rounded-full mx-auto mb-3 flex items-center justify-center text-white text-2xl shadow-lg"
      ...
      <div class="text-xs mt-2.5 leading-relaxed" style="color: var(--color-text-secondary);">
        前端开发者<br/>Vue · TS · Node.js
      </div>
